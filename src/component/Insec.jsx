...
import product13 from '../img/inse.jpg';
import './pesticides.css';  // Make sure this file contains the updated CSS.
...
const Insec = () => (
  <div className="fungicide-page">
    <div className="fungicide-banner">
      ...
      <div className="fungicide-banner-text">Insecticides Product</div> 
    </div>
    <div className="herbicides-header">
    <h1 className="herbicides-title">Insecticides Product</h1>
</div>
