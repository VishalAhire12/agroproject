...
import product13 from '../img/Her.jpg';
import './pesticides.css';
  // Make sure this file contains the updated CSS.
...
const Herb = () => (
  <div className="fungicide-page">
    <div className="fungicide-banner">
      ...
      <div className="fungicide-banner-text">Herbicides Product</div> 
    </div>
    <div className="herbicides-header">
    <h1 className="herbicides-title">Herbicides Product</h1>
</div>
